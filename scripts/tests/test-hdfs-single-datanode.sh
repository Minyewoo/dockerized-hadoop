...
IMAGE_TAG=$IMAGE_TAG IMAGE_REPO=$IMAGE_REPO docker-compose -f ../../docker-compose-single-datanode.yml up -d
...
hdfs dfs -rmdir /test
"
IMAGE_TAG=$IMAGE_TAG IMAGE_REPO=$IMAGE_REPO docker-compose -f ../../docker-compose-single-datanode.yml down -v